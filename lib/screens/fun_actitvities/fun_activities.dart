...
class fun_activities extends StatefulWidget
{

  @override
  State<fun_activities> createState() => _fun_activitiesState();
}

class _fun_activitiesState extends State<fun_activities> {
